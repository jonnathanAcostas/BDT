...
const Home=()=>{
    ...
    return(       
        ...
        <div className="">
          ...
          <h style={{textAlign:"center",marginCenter: "10px"}}> Modales </h>          
            ...
            <p>HAlo (also known as React.js or ReactJS) is an open-source front-end JavaScript library for building user interfaces or UI components. It is maintained by ...
